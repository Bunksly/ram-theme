...
function ram_load_more_portfolio() {
...
add_action('wp_ajax_ram_load_more_portfolio', 'ram_load_more_portfolio');
add_action('wp_ajax_nopriv_ram_load_more_portfolio', 'ram_load_more_portfolio');
